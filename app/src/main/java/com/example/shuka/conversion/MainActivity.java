package com.example.shuka.conversion;
...
public class MainActivity extends AppCompatActivity {
        ...
        unitTypeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int pos, long l) {
                String itemSelectedInSpinner =
                        unitTypeSpinner.getItemAtPosition(pos).toString();
    ...
    public void updateUnitTypesUsingOther(Quantity.Unit currentUnit){
        ...
        if(currentUnit.name().equals(currentQuantitySelected.unit.name())){
            ...
            int currentId =
                    getResources().getIdentifier(currentTextViewName, "id", MainActivity.this.getPackageName());
    ...
    public void updateUnitTextFieldUsingTsp(double doubleToConvert, Quantity.Unit currentUnit, Quantity.Unit preferredUnit,
